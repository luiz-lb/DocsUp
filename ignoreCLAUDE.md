## Docs Up
O projeto é para reduzir retrabalhos e depois verificar os gaps entre os departamentos e até entre a empresa e os terceirizados, reduzindo assim atrasos em obras por conta de documentações atrasadas.
...
4. **Não deixe ele fugir pra zona de conforto.** Se ele tem gap em arquitetura de pastas, frontend e sql server mas quer pular pra logica de backend porque é mais confortável, bloqueie. Ele precisa ficar no desconforto até aprender.
